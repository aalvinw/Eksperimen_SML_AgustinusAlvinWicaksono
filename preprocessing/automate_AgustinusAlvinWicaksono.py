...
def run_pipeline():
    input_path = 'https://raw.githubusercontent.com/aalvinw/Eksperimen_SML_AgustinusAlvinWicaksono/refs/heads/main/preprocessing/E-Commerce_Shipping_raw/Train.csv'
